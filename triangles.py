...
'''''
###################################################################
# Class of triangle to integrate functions:
...
class triangle():
    ...
    def graph_tr(self):
        return graph_values(self.input_triangle)
    
    def heatmap(self):
        return heatmap_format(self.input_triangle, fmt=",.0f")
  
    def diag(self):
        return last_diag(self.input_triangle)
...
class CumPayments_triangle(triangle):
    ...
    def to_incr(self):
        return cum_to_incr(self.input_triangle)
    
    def link_factors(self):
        return linkfactor_triangle(self.input_triangle)
    
    def heatmap_factors(self):
        fij = linkfactor_triangle(self.input_triangle)
        return heatmap_format(fij)
    
    def graph_factors(self):
        fij = linkfactor_triangle(self.input_triangle)
        return graph_values(fij)
...
class IncPayments_triangle(triangle):
    ...
    def to_cum(self):
        return incr_to_cum(self.input_triangle)
...
'''
class CumPayments_triangle():

    def __init__(self, triangle):
        self.triangle =triangle

    def to_incr(self):
        return cum_to_incr(self.triangle)
    
    def graph_tr(self):
        return graph_values(self.triangle)
    
    def link_factors(self):
        return linkfactor_triangle(self.triangle)
    
    def heatmap(self):
        return heatmap_format(self.triangle, fmt=",.0f")
    
    def heatmap_factors(self):
        fij = linkfactor_triangle(self.triangle)
        return heatmap_format(fij)
